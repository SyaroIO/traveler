...
<template>
    <div class="hsl">
        <div class="preview" >
            <div :style="preview[0]"></div>
            <div :style="preview[1]"></div>
            <div :style="preview[2]"></div>
            <div :style="preview[3]"></div>
            <div :style="preview[4]"></div>
            <div :style="preview[5]"></div>
        </div>
        <ul class="ranges">
            <li class="range h">
                <div class="bar" :style="hBar"></div>
                <input type="range" min="0" max="360" v-model="hue" />
            </li>
            <li class="range s">
                <div class="bar" :style="sBar"></div>
                <input type="range" min="0" max="100" v-model="saturation" />
            </li>
            <li class="range l">
                <div class="bar" :style="lBar"></div>
